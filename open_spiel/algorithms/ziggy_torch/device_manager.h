...
#ifndef OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_DEVICE_MANAGER_H_
#define OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_DEVICE_MANAGER_H_
...
#endif  // OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_DEVICE_MANAGER_H_
