...
#ifndef OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_VPEVALUATOR_H_
#define OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_VPEVALUATOR_H_
...
#endif  // OPEN_SPIEL_ALGORITHMS_ZIGGY_TORCH_VPEVALUATOR_H_
